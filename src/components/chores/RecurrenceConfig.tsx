  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        <label className="text-sm font-semibold text-kinship-on-surface-variant w-16 shrink-0">
          Repeat
        </label>
        <select
          value={frequency}
          onChange={(e) => handleFrequencyChange(e.target.value as RecurrenceRule['frequency'])}
          className="flex-1 rounded-lg border border-kinship-outline bg-white px-3 py-2 text-sm text-kinship-on-surface focus:outline-none focus:ring-2 focus:ring-kinship-primary"
        >
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="w-20 rounded-lg border border-kinship-outline bg-white px-3 py-2 text-sm text-kinship-on-surface focus:outline-none focus:ring-2 focus:ring-kinship-primary"
        />
        <span className="text-sm text-kinship-on-surface-variant">
          {frequency === 'daily'
            ? interval === 1
              ? 'day'
              : 'days'
      ...
      {(frequency === 'monthly' || frequency === 'yearly') && (
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="w-20 rounded-lg border border-kinship-outline bg-white px-3 py-2 text-sm text-kinship-on-surface focus:outline-none focus:ring-2 focus:ring-kinship-primary"
          />
          <span className="text-sm text-kinship-on-surface-variant">of the month</span>
        </div>
      )}

      {/* Ends */}
      <div className="flex items-start gap-2">
        <label className="text-sm font-semibold text-kinship-on-surface-variant w-16 shrink-0 pt-2">
          Ends
        </label>
        <div className="flex flex-col gap-2">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-kinship-on-surface">No end date</span>
          </label>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="radio"
              ...
              className="accent-kinship-primary"
            />
            <span className="text-sm text-kinship-on-surface">On date</span>
          </label>
