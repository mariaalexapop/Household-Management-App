    ...
    >
      <DayPicker
        ...
        classNames={{
          ...
          button_previous: 'flex h-9 w-9 items-center justify-center rounded-lg border border-border hover:bg-kinship-surface-container active:bg-kinship-surface-container text-kinship-on-surface transition-colors cursor-pointer',
          button_next: 'flex h-9 w-9 items-center justify-center rounded-lg border border-border hover:bg-kinship-surface-container active:bg-kinship-surface-container text-kinship-on-surface transition-colors cursor-pointer',
