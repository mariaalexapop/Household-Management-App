...
export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [sendInviteEmail, generateRecurrence, sendTaskAssignedEmail, sendTaskReminder, generateActivityRecurrence, sendActivityReminder, sendWarrantyReminder],
})
